    ...
    const handleAuth = async (e: React.FormEvent) => {
        ...
        try {
            if (view === "LOGIN") {
                ...
                // --- STRICT PHONE VALIDATION ADDED HERE ---
                ...
                <AnimatePresence mode="wait">
                    <motion.div key={view} initial={{ opacity: 0, x: 10 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: -10 }}>
                        ...
                        <form onSubmit={handleAuth} className="space-y-4">
                            ...
                            <button disabled={isLoading} className={`w-full h-12 font-bold uppercase tracking-widest text-[11px] rounded-lg transition-all disabled:opacity-50 mt-4 border flex items-center justify-center gap-2 relative z-10 ${
